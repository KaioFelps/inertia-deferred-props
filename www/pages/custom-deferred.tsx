...
import CustomDeferred from "../components/deferred";
...
export default function CustomDeferredPage() {
    ...
    return (
        <main className="main-container">
            <h1 className="mb-12 p-20 bg-amber-100">Listing users with <span className="underline">custom</span> Deferred component</h1>

            <CustomDeferred data="users" fallback={<DeferredUsersSkeleton />}>
                <DeferredUsers/>
            </CustomDeferred>
